...
def get_edge_feature(point_cloud, nn_idx, k=20,keep_central=True,get_neighboor=False):
    ...
    if keep_central==False:
        edge_feature = tf.concat([point_cloud_neighbors-point_cloud_central], axis=-1)
    else:
